...
class VerifySimatRpsPatch05K extends Command
{
    ...
    protected $description = 'Verifikasi AI kontekstual per minggu dan CPMK no-op guard';
    ...
    public function handle(): int
    {
        ...
        $checks = [
            ['POST AI per minggu', $weekRoute],
            ['Provider generateWeek()', str_contains($provider, 'public function generateWeek')],
            ['Direct apply minggu', str_contains($controller, 'public function generateWeek')],
            ...
            ['UI AI per baris minggu', str_contains($ui, 'Lengkapi AI')],
            ...
            ['Global 14 minggu dihapus', ! str_contains($ui, 'Susun 14 Minggu dengan AI')],
