...
# AI: Detail Asesmen is the only source for assessment form/weight.
...
# Read-side guard for legacy weekly forms.
...
# UI source-of-truth and exact validator targeting.
...
# Clear content keeps/reasserts assessment source.
