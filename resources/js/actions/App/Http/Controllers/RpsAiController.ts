...
/**
* @see \App\Http\Controllers\RpsAiController::generateWeek
 * @see app/Http/Controllers/RpsAiController.php:185
 * @route '/rps/{rps}/ai/weeks/{week}'
 */
export const generateWeek = (args: { rps: string | number, week: string | number } | [rps: string | number, week: string | number ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: generateWeek.url(args, options),
    method: 'post',
})

generateWeek.definition = {
    methods: ["post"],
 ...
 * @route '/rps/{rps}/ai/weeks/{week}'
 */
generateWeek.url = (args: { rps: string | number, week: string | number } | [rps: string | number, week: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    rps: args[0],
                    week: args[1],
    ...
    return generateWeek.definition.url
            .replace('{rps}', parsedArgs.rps.toString())
 ...
 * @route '/rps/{rps}/ai/weeks/{week}'
 */
generateWeek.post = (args: { rps: string | number, week: string | number } | [rps: string | number, week: string | number ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: generateWeek.url(args, options),
    method: 'post',
})
 ...
 * @route '/rps/{rps}/ai/weeks/{week}'
 */
    const generateWeekForm = (args: { rps: string | number, week: string | number } | [rps: string | number, week: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: generateWeek.url(args, options),
        method: 'post',
    })
 ...
 * @route '/rps/{rps}/ai/weeks/{week}'
 */
        generateWeekForm.post = (args: { rps: string | number, week: string | number } | [rps: string | number, week: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: generateWeek.url(args, options),
            method: 'post',
        })
    
    generateWeek.form = generateWeekForm
/**
...
const RpsAiController = { generate, generateWeek, apply, reject }

export default RpsAiController