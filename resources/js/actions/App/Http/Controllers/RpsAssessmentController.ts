...
/**
* @see \App\Http\Controllers\RpsAssessmentController::updateMatrix
 * @see app/Http/Controllers/RpsAssessmentController.php:122
 * @route '/rps/{rps}/assessments/{assessment}/matrix'
 */
export const updateMatrix = (args: { rps: string | number, assessment: string | number } | [rps: string | number, assessment: string | number ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updateMatrix.url(args, options),
    method: 'put',
})

updateMatrix.definition = {
    methods: ["put"],
 ...
 * @route '/rps/{rps}/assessments/{assessment}/matrix'
 */
updateMatrix.url = (args: { rps: string | number, assessment: string | number } | [rps: string | number, assessment: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    rps: args[0],
                    assessment: args[1],
    ...
    return updateMatrix.definition.url
            .replace('{rps}', parsedArgs.rps.toString())
            .replace('{assessment}', parsedArgs.assessment.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/rps/{rps}/assessments/{assessment}/matrix'
 */
updateMatrix.put = (args: { rps: string | number, assessment: string | number } | [rps: string | number, assessment: string | number ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updateMatrix.url(args, options),
    method: 'put',
})
 ...
 * @route '/rps/{rps}/assessments/{assessment}/matrix'
 */
    const updateMatrixForm = (args: { rps: string | number, assessment: string | number } | [rps: string | number, assessment: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: updateMatrix.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PUT',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/rps/{rps}/assessments/{assessment}/matrix'
 */
        updateMatrixForm.put = (args: { rps: string | number, assessment: string | number } | [rps: string | number, assessment: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateMatrix.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    updateMatrix.form = updateMatrixForm
/**
...
const RpsAssessmentController = { store, update, updateMatrix, destroy }

export default RpsAssessmentController