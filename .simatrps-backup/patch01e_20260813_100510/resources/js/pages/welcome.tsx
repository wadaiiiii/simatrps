                ...
                <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-6 lg:px-8">
                    <header className="flex items-center justify-between">
                        ...
                        <Link
                            ...
                            className="rounded-xl border border-blue-200 bg-[#f1f7fd]/80 px-4 py-2 text-sm font-bold text-[#163A63] shadow-sm backdrop-blur transition hover:border-blue-300 hover:bg-[#f7fbff]"
                        >
                            {auth.user ? 'Dashboard' : 'Masuk'}
                        </Link>
                    </header>

                    <section className="grid flex-1 items-center gap-12 py-14 lg:grid-cols-[1.04fr_.96fr] lg:py-16">
                        <div>
                            ...
                            <h1 className="mt-6 max-w-3xl text-4xl font-black tracking-[-0.04em] text-[#0b132b] sm:text-5xl lg:text-6xl">
                                <span className="text-[#163A63]">SiMatRPS:</span>
                                <span className="mt-2 block leading-[1.04]">
                                    <span className="italic text-[#1F5D99]">Workspace</span> praktis untuk menyusun
                                    RPS berbasis OBE secara
                                    <span className="block bg-gradient-to-r from-[#163A63] via-[#1F5D99] to-[#55A6F2] bg-clip-text text-transparent">
                            ...
                            <p className="mt-6 max-w-2xl text-base leading-8 text-slate-600 lg:text-lg">
                                <strong className="font-semibold text-[#163A63]">SiMatRPS:</strong>{' '}
                                <span className="italic">Workspace</span> praktis untuk menyusun RPS berbasis OBE secara terstruktur dan terarah.
                            </p>
                        ...
                        <div className="relative">
                            <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-blue-100/70 via-sky-50 to-cyan-100/60 blur-xl" />
                            <div className="sim-surface relative rounded-[28px] p-5">
                                <div className="sim-gradient-brand rounded-2xl p-[1px]">
                                    <div className="rounded-2xl bg-[#f3f8fe]/92 p-6">
                                        <div className="flex items-center gap-3">
                                            <div className="rounded-xl bg-blue-50 p-3 text-[#1F5D99]">
                                        ...
                                        <div className="mt-6 space-y-3">
                                            {steps.map((step, index) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-[#1F5D99]">
