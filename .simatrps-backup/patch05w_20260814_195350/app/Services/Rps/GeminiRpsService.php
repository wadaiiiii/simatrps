...
class GeminiRpsService
{
    ...
    {
        if (str_contains($this->model(), 'flash-lite')) {
            return 0;
        }
    ...
    private function throwApiError(int $status, mixed $body): never
    {
        ...
        $friendly = match ($status) {
            ...
            404 => 'Model Gemini yang dipilih tidak ditemukan atau tidak tersedia. Jalankan ulang simatrps:ai-config dan pilih model stabil terbaru.',
