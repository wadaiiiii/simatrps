...
Tugas: telaah Bahan Kajian RPS. Gunakan HANYA topik yang dapat diturunkan dari `syllabus_items`, CPMK, dan Sub-CPMK pada konteks. Jangan mengarang materi di luar silabus. Gunakan `link` untuk bahan kajian yang sudah ada tetapi perlu dikaitkan ke Sub-CPMK, `adapt` jika judul bahan kajian yang ada perlu dirapikan tanpa mengubah substansi, dan `add` hanya bila ada topik silabus penting yang belum terdapat pada daftar bahan kajian. Hindari duplikasi. Setiap usulan harus menunjuk satu Sub-CPMK yang relevan bila Sub-CPMK tersedia.
PROMPT,
            'sub_cpmk' => <<<'PROMPT'
            ...
            'properties' => [
                ...
                'items' => [
                    ...
                    'items' => [
                        ...
                        'required' => ['action','target_title','title','sub_cpmk_code','rationale'],
                        'additionalProperties' => false,
                    ],
                ],
            ],
