...
export function AppSidebar() {
    ...
    return (
        <Sidebar collapsible="icon" variant="inset" className="border-r border-cyan-100/80 bg-gradient-to-b from-[#eef8ff] via-[#edf9ff] to-[#eefaf4]">
            <SidebarHeader className="border-b border-cyan-100/80 bg-white/35">
                <SidebarMenu>
                    <SidebarMenuItem>
            ...
            <SidebarFooter className="border-t border-teal-100/80">
                ...
                <div className="mb-1 flex items-center justify-end px-1 group-data-[collapsible=icon]:justify-center">
                    <SidebarTrigger
                        className="size-8 rounded-lg border border-cyan-100 bg-white/90 text-teal-800 shadow-sm hover:bg-white"
