                    ...
                    <section className="grid flex-1 items-center gap-12 py-16 lg:grid-cols-[1.05fr_.95fr]">
                        <div>
                            ...
                            <h1 className="mt-6 max-w-3xl text-4xl font-black tracking-[-0.04em] text-slate-950 sm:text-5xl lg:text-6xl">
                                RPS berbasis OBE,
                                <span className="block text-[#008080]">lebih rapi dan terarah.</span>
                            </h1>

                            <p className="mt-6 max-w-2xl text-base leading-7 text-slate-600 lg:text-lg">
                                SiMatRPS menghubungkan kurikulum, CPL, CPMK, Sub-CPMK,
                                rencana pembelajaran dan asesmen dalam satu workspace.
                                AI memberi rekomendasi, keputusan akademik tetap pada dosen.
                            </p>
                            ...
                            <div className="sim-surface relative rounded-[28px] p-5">
                                <div className="rounded-2xl border border-teal-100 bg-gradient-to-br from-white to-teal-50/50 p-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-slate-900">Alur OBE SiMatRPS</p>
                                            <p className="text-xs text-slate-500">
                                                Terstruktur dari kurikulum hingga dokumen
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 space-y-3">
                                        {[
                                            ...
                                            >
                                                <div className="mt-0.5 flex size-6 shrink-0 items-center justify-center rounded-full bg-teal-50">
