...
class RpsController extends Controller
{
    ...
    public function show(
        ...
        $effectiveReferenceText = trim((string) (
            $storedMeta?->reference_text
                ?: $masterReferenceText
        ));

        $bibliography = $this->parseBibliography($effectiveReferenceText);
        ...
        $documentMeta = [
            ...
            'reference_text' => $effectiveReferenceText,
        ];

        $masterSyllabus = [
            'description' => $masterDescription,
            'reference_text' => $masterReferenceText,
