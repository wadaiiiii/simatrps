...
class RpsController extends Controller
{
    ...
    public function show(
        ...
        $weeks = $weeks->map(function ($week) use (
            ...
            $week->assessment_weight = (float) ($assessmentWeightsByWeek->get((int) $week->week_number, 0));
        ...
        $courseSummary = [
            ...
            'prerequisite' => $syllabus?->source_prerequisite_text
                ?: ($record->prerequisite_note ?? null),
