...
class GroqRpsService
{
    ...
    {
        return (string) config('simatrps-ai.model', 'openai/gpt-oss-120b');
    }
    ...
    public function testConnection(): array
    {
        ...
        $response = $this->client()->get(
            config('simatrps-ai.base_url').'/models/'.$this->model()
        );
    ...
    public function generate(string $type, array $context, ?string $instruction = null): array
    {
        ...
        $response = $this->client()->post(
            config('simatrps-ai.base_url').'/chat/completions',
            [
                'model' => $this->model(),
                'messages' => [
                    [
                ...
                'temperature' => 0.2,
                'max_completion_tokens' => (int) config('simatrps-ai.max_output_tokens', 6000),
                'response_format' => [
                    'type' => 'json_schema',
                    'json_schema' => [
                        'name' => 'simatrps_'.$type,
