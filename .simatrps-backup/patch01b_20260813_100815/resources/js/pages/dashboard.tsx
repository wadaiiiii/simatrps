    ...
    return (
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto bg-transparent p-4 md:p-6">
                <section className="sim-gradient-brand relative overflow-hidden rounded-[28px] p-7 text-white shadow-xl shadow-blue-900/10 md:p-9">
                    <div className="absolute -right-16 -top-20 size-64 rounded-full border border-white/15 bg-white/5" />
                    <div className="absolute -bottom-24 right-24 size-52 rounded-full border border-cyan-100/15 bg-cyan-200/10" />
                    <div className="absolute inset-y-0 left-0 w-1.5 bg-[#8fd0ff]" />
                    ...
                    <div className="relative max-w-3xl">
                        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-medium text-white/90 backdrop-blur">
                            <Sparkles className="size-3.5 text-[#8fd0ff]" />
                        ...
                        <div className="mt-6 flex flex-wrap gap-3">
                            <Link
                                href="/rps/baru"
                                className="inline-flex items-center gap-2 rounded-xl bg-[#f7fbff] px-4 py-2.5 text-sm font-bold text-[#163A63] shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
                            >
                ...
                <section className="grid gap-4 xl:grid-cols-[1.35fr_.65fr]">
                    <div className="sim-surface overflow-hidden rounded-2xl">
                        <div className="flex items-center justify-between border-b border-slate-100 p-5">
                            ...
                            <Link href="/rps" className="inline-flex items-center gap-1 text-xs font-bold text-[#1F5D99] hover:text-[#163A63]">
                                Lihat semua
                        ...
                        <div className="flex min-h-56 flex-col items-center justify-center p-6 text-center">
                            <div className="rounded-2xl bg-blue-50 p-3 text-[#1F5D99]">
                    ...
                    <div className="sim-surface rounded-2xl p-5">
                        ...
                        <div className="mt-5 space-y-4 text-sm">
                            {[
                                ['Laravel 13', 'Aktif', 'text-cyan-700'],
                                ['React / Inertia', 'Aktif', 'text-cyan-700'],
                                ['Role', roleLabel, 'text-[#1F5D99]'],
                                ['Engine OBE', 'Tahap berikutnya', 'text-blue-700'],
