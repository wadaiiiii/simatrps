        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto bg-transparent p-4 md:p-6">
                <section className="sim-gradient-brand relative overflow-hidden rounded-[28px] p-7 text-white shadow-xl shadow-teal-900/10 md:p-9">
                    ...
                    <div className="relative max-w-3xl">
                        ...
                        <p className="mt-3 max-w-2xl text-sm leading-6 text-teal-50 md:text-base">
                            ...
                            dari master kurikulum resmi, validasi keterkaitan OBE, dan
                            gunakan rekomendasi AI secara terkontrol.
                        </p>

                        <div className="mt-6 flex flex-wrap gap-3">
                            <Link
                                href="/rps/baru"
                                className="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-bold text-teal-800 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
                            >
                ...
                <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    {statItems.map((item) => {
                        ...
                        return (
                            <div
                                key={item.label}
                                className="sim-surface sim-card-hover rounded-2xl p-5"
                            >
                ...
                <section className="grid gap-4 xl:grid-cols-[1.35fr_.65fr]">
                    <div className="sim-surface rounded-2xl overflow-hidden">
                        <div className="flex items-center justify-between border-b border-slate-100 p-5">
                            ...
                            <Link href="/rps" className="inline-flex items-center gap-1 text-xs font-bold text-teal-700 hover:text-teal-900">
                                Lihat semua
                    ...
                    <div className="sim-surface rounded-2xl p-5">
                        ...
                        <div className="sim-accent-line mt-6 h-1.5 rounded-full" />
                    </div>
                </section>
            </div>
        </>
